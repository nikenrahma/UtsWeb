const input = document.getElementById('input');
        ...
        ubahBackgroundButton.addEventListener('click', function() {
            // Periksa apakah teks yang dimasukkan adalah "biru" dan setel latar belakang kolom 1 sesuai kondisi
        ...
        ubahBackgroundButton.addEventListener('click', function() {
            // Periksa apakah teks yang dimasukkan adalah "kuning" dan setel latar belakang kolom 1 sesuai kondisi
        ...
        ubahBackgroundButton.addEventListener('click', function() {
            // Periksa apakah teks yang dimasukkan adalah "ungu" dan setel latar belakang kolom 1 sesuai kondisi
        ...
        ubahBackgroundButton.addEventListener('click', function() {
            // Periksa apakah teks yang dimasukkan adalah "pink" dan setel latar belakang kolom 1 sesuai kondisi
